...
/opt/miniconda/envs/stock/bin/python script/convert_raw_data.py dump_all --symbol_field_name ts_code --date_field_name trade_date --include_fields high,open,low,close,vol --csv_path /home/greetlist/workspace/data_storage/tushare/raw/day --qlib_dir /home/greetlist/workspace/data_storage/qlib/
